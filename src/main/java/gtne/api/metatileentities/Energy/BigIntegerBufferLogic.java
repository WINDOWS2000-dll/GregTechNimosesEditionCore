package gtne.api.metatileentities.Energy;
...
import gtne.common.metatileentities.multi.MultiBlockWithUpdatable;
...
public class BigIntegerBufferLogic<T extends MultiBlockWithUpdatable<?> & IMetaTileEntityChangeableBattery<T>> implements IEnergyBufferLogic<BigInteger>, IUpdatable {
