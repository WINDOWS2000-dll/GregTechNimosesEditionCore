...
public class GTNERecipeMaps {
    ...
    @ZenProperty
    public static final RecipeMapProtTypeSuperComputer<ComputerRecipeBuilder> ProtTypeSuperComputer = (RecipeMapProtTypeSuperComputer<ComputerRecipeBuilder>) new RecipeMapProtTypeSuperComputer<>("prottype_supercomputer", 1 ,12, 1, 1, 0, 2, 0, 0, new ComputerRecipeBuilder(), false)
            .setProgressBar(GuiTextures.PROGRESS_BAR_ARROW, MoveType.HORIZONTAL)
