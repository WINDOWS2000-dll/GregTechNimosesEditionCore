...
public class GTNEMaterialIconSet{
    ...
    public static final MaterialIconSetWithRenderer INFINITY = new MaterialIconSetWithRenderer("infinity", null, true, new HaloRenderItemBehavior(10, 0xFF000000, () -> GTNETextures.HALO, true));
